...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description='Clean Flickr8k experiment runner.')
    ...
    parser.add_argument('--alphas', type=str, default='0.05,0.10,0.15,0.20')
    parser.add_argument('--methods', type=str, default='TOPK,ICP,LEARNT_CP,CFC,CFC_PAC')
    parser.add_argument('--difficulty-proxy', type=str, default='mean_loss', choices=sorted(DIFFICULTY_PROXIES))
    ...
    parser.add_argument('--max-candidates', type=int, default=0, help='Optional cap on cached unique candidates per image; 0 keeps all.')
    parser.add_argument('--cache-dir', type=str, default=None)
    parser.add_argument('--run-dir', type=str, required=True)
    parser.add_argument('--force-rebuild-cache', action='store_true')
    parser.add_argument('--no-exact', action='store_true')
    parser.add_argument('--topk-max-k', type=int, default=6)
